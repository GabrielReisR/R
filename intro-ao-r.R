...
#' Uma série de operações podem ser feitas.
#' 
...
#' 
#' Agora que já sabemos o básico, podemos ser introduzidos à função `rep()`, que
...
#'   Já que j = 3, `ncol = 3`.
#' 
#' Agora que está criada, podemos acessar elementos específicos dessa matriz. Para
...
#' Criamos duas strings: uma que contém o valor `Isso é uma string` e outro que 
#' contém o valor `"10"` - esse "10" não é um número pois está entre aspas.
#' 
